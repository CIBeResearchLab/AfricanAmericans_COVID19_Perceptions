...
consumer_key = "2AU96bFFBIEmQ34TlDNDtsiou"  # Add your API key here
consumer_secret = "sMvxN6oU6DYbiNhVMJvEfHDiLi8eRUwtsvbjKaDoeeDZctADNy"  # Add your API secret key here
records_per_file = 20000  # Replace this with the number of tweets you want to store per file
file_path = "/Users/Meghna/Desktop/Twitter_Covid_Data/"  # Replace with appropriate file path followed by / where you want to store the file
