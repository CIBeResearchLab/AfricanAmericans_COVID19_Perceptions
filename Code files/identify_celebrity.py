...
subscription_key = "cf7efaebbb98435a8bbb047956cb498f"
endpoint = "https://celebdetection.cognitiveservices.azure.com/"

computervision_client = ComputerVisionClient(endpoint, CognitiveServicesCredentials(subscription_key))

with open('/Users/Meghna/Desktop/modified_urls.json','rb') as f, open('/Users/Meghna/Desktop/celebrities.json', 'a') as u :
    for line in f:
