...
os.environ['COMPUTER_VISION_ENDPOINT']='https://imagedescription.cognitiveservices.azure.com/'
os.environ['COMPUTER_VISION_SUBSCRIPTION_KEY']='deff0d6fd8d74085bfe9d44ae365b7a1'
...
with open('/Users/Meghna/Desktop/test_images_no_celeb.json','rb') as f, open('/Users/Meghna/Desktop/test_data_potraits.json', 'a') as u :
    for line in f:
